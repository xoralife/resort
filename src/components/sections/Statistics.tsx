...
export function Statistics() {
  return (
    <section className="border-t border-gray-100 bg-white py-20 dark:border-gray-800 dark:bg-dark sm:py-24">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {STATS_DATA.map((stat, i) => {
            ...
            return (
              ...
              >
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-light dark:bg-primary-dark">
