  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, var(--bg-hero-overlay), var(--bg-hero-overlay-2), var(--bg-hero-overlay-3))",
        }}
      />
      ...
      <div className="absolute bottom-8 left-1/2 z-30 -translate-x-1/2">
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex h-7 w-4 items-start justify-center rounded-full border border-gray-300 dark:border-gray-600">
            <motion.div
              animate={{ y: [0, 6, 0] }}
              transition={{ duration: 1.5, repeat: Infinity, ease: "easeInOut" }}
              className="mt-1.5 h-1.5 w-1 rounded-full bg-gray-400 dark:bg-gray-500"
            />
          </div>
        </div>
      </div>
